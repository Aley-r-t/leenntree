  ...
  return (
    <main style={{ padding: '2rem', maxWidth: '800px', margin: 'auto', fontFamily: 'Segoe UI, sans-serif', background: '#fff', color: '#333', lineHeight: 1.6, borderRadius: '10px', boxShadow: '0 4px 20px rgba(0, 0, 0, 0.1)' }}>
      <article style={{ animation: 'fadeIn 0.6s ease-in' }}>
        <h1 style={{ fontSize: '2rem', fontWeight: 'bold', marginBottom: '1rem', color: '#3a0ca3' }}>Nota: Es para tener un recuerdo de c&oacute;mo empec&eacute;</h1>
        <h2 style={{ fontSize: '1.5rem', fontWeight: 600, marginTop: '2rem', color: '#4361ee' }}>C&oacute;mo me perd&iacute; a m&iacute; mismo</h2>
